...
<head>
    ...
    <meta name="msapplication-TileImage" content="{{ asset('dist/front/img/favicons/ms-icon-144x144.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('dist/front/css/magnific-popup.min.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/front/css/slick.min.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/front/css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/front/css/imageRevealHover.css') }}">
    <!-- Theme Custom CSS -->
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            ...
                            <a href="#"><img src="{{ asset('dist/front/img/product/product_thumb_1_1.jpg') }}" alt="Cart Image">Ripple Crewneck</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="fas fa-times"></i></a>
                            <a href="#"><img src="{{ asset('dist/front/img/product/product_thumb_1_2.jpg') }}" alt="Cart Image">Herman Miller</a>
                            <span class="woocommerce-Price-amount amount">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{ asset('dist/front/img/logo.svg') }}" alt="logo"></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-5 col-lg-6">
                        <div class="widget widget-newsletter footer-widget">
                            ...
                            <form class="newsletter-form">
                                ...
                                <button type="submit" class="btn"><img src="{{ asset('dist/front/img/icon/arrow-left-top.svg') }}" alt=""></button>
                            </form>
