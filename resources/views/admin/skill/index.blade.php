    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                                ...
                                <table class="table table-bordered" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $skill->item_order }}</td>
                                            <td class="pt_10 pb_10">
                                                <a href="" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal_edit_{{ $skill->id }}"><i class="fas fa-edit"></i></a>
                                                <a href="" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal_delete_{{ $skill->id }}"><i class="fas fa-trash"></i></a>
                                            </td>
                <div class="modal fade" id="modal_edit_{{ $skill->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <label for="">Item Order</label>
                                        <input type="text" class="form-control" name="item_order" value="{{ $skill->item_order }}">
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modal_delete_{{ $skill->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
